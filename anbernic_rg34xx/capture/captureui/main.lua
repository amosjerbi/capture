...
-- Capture modes
local modes = {
    {name = "Screenshot Hotkey", description = "SELECT+R1 captures screenshot", command = "hotkey_screenshot", duration = 0},
    {name = "Record 5s Hotkey", description = "SELECT+R1 records 5 seconds", command = "hotkey_record", duration = 5},
    {name = "Record 10s Hotkey", description = "SELECT+R1 records 10 seconds", command = "hotkey_record", duration = 10},
    {name = "Record 30s Hotkey", description = "SELECT+R1 records 30 seconds", command = "hotkey_record", duration = 30},
...
function love.load()
    ...
    if fontExists then
        ...
        headerFont = love.graphics.newFont(fontPath, 24)
...
function drawMenuScreen()
    ...
    if selectedMode.command == "screenshot" then
        love.graphics.printf("Output: /storage/roms/screenshots/", 0, 445, gameWidth, 'center')
    else
        love.graphics.printf("Output: /storage/roms/recordings/", 0, 445, gameWidth, 'center')
    end
end
