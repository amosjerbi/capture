...
Monitors gamepad for SELECT+R1 combo to capture screenshots or video
...
class HotkeyDaemon:
    ...
    def check_hotkey(self):
        """Check if hotkey combo is pressed (SELECT + R1)"""
        return BTN_SELECT in self.buttons_pressed and BTN_R1 in self.buttons_pressed
