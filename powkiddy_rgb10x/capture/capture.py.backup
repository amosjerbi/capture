...
def bgr0_to_rgb(raw_data, width, height, pitch):
    """Convert BGR0 (XRGB8888) to RGB for PNG"""
    rgb_data = bytearray()
...
def take_screenshot(output_path=None):
    ...
    try:
        ...
        rgb_data = bgr0_to_rgb(raw_data, width, height, pitch)
